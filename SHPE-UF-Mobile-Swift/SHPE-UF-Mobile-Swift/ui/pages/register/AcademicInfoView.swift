            ...
            VStack
            {
                ...
                VStack(alignment: .leading, spacing: 10)
                {
                    ...
                    HStack(spacing: 0)
                    {
                        ...
                        .accentColor(.black)
                        .onChange(of: viewModel.majorInput) {newValue in viewModel.majorPickerInteracted = true
                        }
                        ...
                        HStack(spacing: 0)
                        {
                            ...
                            .accentColor(.black)
                            .onChange(of: viewModel.classYearInput) {newValue in viewModel.classYearPickerInteracted = true
                            }
                            .pickerStyle(MenuPickerStyle())
                            .frame(width: 270)
                            .background(Color.white)
                            ...
                            HStack(spacing: 0)
                            {
                                ...
                                .accentColor(.black)
                                .onChange(of: viewModel.gradYearInput) {newValue in viewModel.gradYearPickerInteracted = true
                                }
                                .pickerStyle(MenuPickerStyle())
